  ...
  return (
    <FinalForm
      ...
      render={fieldRenderProps => {
        ...
        const hasPassword = userHasPassword(currentUser);
        ...
        const submitDisabled =
          invalid || inProgress || !(deleteAccountConfirmed && currentPassword) || !hasPassword;
          ...
          >
            ...
            <div className={confirmClasses} aria-hidden={!deleteAccountConfirmed}>
              ...
              {hasPassword ? (
                ...
                <div className={css.googleAccountSection}>
                  <p className={css.confirmChangesInfo}>
                    <FormattedMessage
                      id="DeleteAccountForm.googleAccountInfo"
                      values={{ email: <span className={css.emailStyle}>{email}</span> }}
                    />
                  </p>
                  ...
                  {showResetPasswordMessage || resetPasswordInProgress ? (
                    <p className={css.confirmChangesInfo}>
                      <FormattedMessage
                        id="DeleteAccountForm.passwordEmailSent"
                        values={{ email: <span className={css.emailStyle}>{email}</span> }}
                      />
                    </p>
                  ) : null}
                  ...
                  <button
                    type="button"
                    className={css.sendPasswordEmailButton}
                  ...
                  >
                    <FormattedMessage
                      id={
                        showResetPasswordMessage || resetPasswordInProgress
                          ? 'DeleteAccountForm.resendPasswordEmailButton'
                          : 'DeleteAccountForm.sendPasswordEmailButton'
                      }
                    />
                  </button>
                </div>
