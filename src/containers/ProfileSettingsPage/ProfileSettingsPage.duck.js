...
// Clears the user's profile picture by setting profileImageId to null and
// refreshing the cached currentUser so the avatar reverts to initials.
export const removeProfileImage = () => dispatch =>
  dispatch(updateProfileThunk({ profileImageId: null }));
