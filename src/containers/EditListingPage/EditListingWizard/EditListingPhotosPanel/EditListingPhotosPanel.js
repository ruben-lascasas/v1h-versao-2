...
const getInitialValues = params => {
  ...
  const youtubeUrl = listing?.attributes?.publicData?.youtubeUrl || '';
  ...
  return (
    <main className={classes}>
      ...
      <EditListingPhotosForm
        ...
        onSubmit={values => {
          const { addImage, youtubeUrl, ...updateValues } = values;
          // Persist the YouTube link under publicData so the listing page can
          // render the embed as the last carousel item. Empty input → null
          // clears the field on Sharetribe.
