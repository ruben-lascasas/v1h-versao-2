...
// Computed-only fields that the host should never edit by hand. These are
// populated by backend scripts/cron (e.g. backfill-listing-ratings.js).
// Listing fields whose data still lives in publicData but should NOT
// surface as editable dropdowns/inputs in the Edit Listing form:
// - averageRating / reviewCount: backend-only stats.
// - featured / featuredAt: written by the "Destacar Anúncio" page flow
//   (with admin email notification) — letting hosts toggle them
