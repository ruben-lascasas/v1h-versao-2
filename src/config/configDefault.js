...
const defaultConfig = {
  ...
  // Listing maximum price in currency sub units (cents). Used to cap the
  // price input on the EditListing pricing form. e.g. 1000000 = 10 000,00 €.
  listingMaximumPriceSubUnits: 1000000,
