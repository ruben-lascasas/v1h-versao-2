/**
 * Os 308 municípios de Portugal (Continente, Açores e Madeira), agrupados por
 * distrito/região autónoma apenas para facilitar a manutenção desta lista —
 * o array exportado é uma lista simples, ordenada alfabeticamente.
 *
 * Usado pelo autocomplete de localização do registo (ver
 * containers/AuthenticationPage/CityAutocompleteField.js) para sugerir
 * cidades/municípios à medida que o utilizador escreve, sem depender de um
 * serviço de geocodificação externo (Mapbox/Google Maps).
 */
...
const BY_DISTRICT = {
  ...
  Faro: [
    'Albufeira', 'Alcoutim', 'Aljezur', 'Castro Marim', 'Faro', 'Lagoa (Algarve)',
  ...
  Guarda: [
    ...
    'Fornos de Algodres', 'Gouveia', 'Guarda', 'Manteigas', 'Mêda', 'Pinhel',
  ...
  Porto: [
    ...
    'Marco de Canaveses', 'Matosinhos', 'Paços de Ferreira', 'Paredes', 'Penafiel',
    'Porto', 'Póvoa de Varzim', 'Santo Tirso', 'Trofa', 'Valongo', 'Vila do Conde',
    'Vila Nova de Gaia',
  ],
  Santarém: [
  ...
  'Região Autónoma da Madeira': [
    ...
    'Porto Moniz', 'Porto Santo', 'Ribeira Brava', 'Santa Cruz (Madeira)', 'Santana',
    'São Vicente',
  ],
};

export const PORTUGAL_CITIES = Object.values(BY_DISTRICT)
  .flat()
  .sort((a, b) => a.localeCompare(b, 'pt'));

export default PORTUGAL_CITIES;
