...
// Recompute and persist a listing's averageRating + reviewCount in publicData.
// Triggered after a review is submitted so the rating filter can query Sharetribe
// directly via pub_averageRating instead of filtering client-side.
export const recomputeListingRating = body => {
  return post('/api/recompute-listing-rating', body);
};
