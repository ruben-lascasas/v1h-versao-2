...
const mapMarker = () => {
  // Brand red — matches the location pins on listing cards / map info bubbles.
  return new window.mapboxgl.Marker({ color: '#cc0000' });
};
...
class DynamicMapboxMap extends Component {
  ...
  componentDidMount() {
    ...
    // Force resize after browser finishes layout
