...
const markerOverlay = center => {
  // `+cc0000` overrides Mapbox's default dark grey pin so it matches the
  // brand red marker used in the interactive map and listing cards.
  return `pin-s+cc0000(${center.lng},${center.lat})`;
};
...
export default lazyLoadWithDimensions(StaticMapboxMap);
